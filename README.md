...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/movingpandas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7877&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/movingpandas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `movingpandas` can be installed with:

```
conda install movingpandas
```

It is possible to list all of the versions of `movingpandas` available on your platform with:
